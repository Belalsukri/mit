...
const deletBtn =(blogerId)=>{
  ...
  return(
    <div className='card mb-2  col-lg-5 mx-5  card1 mt-4' key={blog._id}>   
        ...
        <h5 className="card-title">{blog.sumTitle}</h5>
    ...
    <button type="button" className="btn btn-success col-5"><Link className="text-white" to={"/Editbloger1/"+blog._id}>Edit</Link></button>
  ...
  >
      ...
      <div className="row  mt-5">
        <div className="row  col-sm-12  col-lg-12 mt-5">
            <h3 className="col-sm-12 text-white mt-auto p-2 d-flex justify-content-center my pt-5">Dashboard Veranstaltungen</h3>
